...
在 DSH 顶栏一键管理你的 Spring Boot 后端：源码直启 / Jar 打包启动 / 停止 / 重启，带实时日志控制台（服务日志 · 请求日志 · 编译输出），无需离开对话即可观察与操作后端进程。
...
| **编译输出** | Maven 编译/打包过程输出（stdout+stderr 合并） |
...
#   "dsh-spring-widget": "link:C:/Users/<你的用户名>/.dsh/plugins/dsh-spring-widget"
...
- [DSH 插件生态 · dsh-plugin topic](https://github.com/topics/dsh-plugin)